...
/**
 * This class represents an ARM Addressing Mode 2 address, used for the data processing and logic
 * instructions.
 *
 * @author   David Liu
 * @version  1.00
...
public class Address2 implements Constants {
     ...
     */
    private Address2(boolean preIndexed, int type, Register base, Register index, int immOffset, boolean updateBase, int scaleMode, int shift) {
    ...
    public static Address2 pre(Register base) {
        return new Address2 (true, ADDR_IMM, base, NO_REG, 0, false, 0, 0);
    }
    ...
    public static Address2 pre(Register base, int imm12) {
        return new Address2 (true, ADDR_IMM, base, NO_REG, imm12, false, 0, 0);
    }
    ...
    public static Address2 pre(Register base, int sign, Register index) {
        return new Address2 (true, ADDR_REG, base, index, sign, false, 0, 0);
    }
    ...
    public static Address2 pre(Register base, int sign, Register index, int shift, int imm) {
        ...
        return new Address2 (true, ADDR_SCALE, base, index, sign, false, shift, imm);
    }
    ...
    public static Address2 preW(Register base, int imm12) {
        return new Address2 (true, ADDR_IMM, base, NO_REG, imm12, true, 0, 0);
    }
    ...
    public static Address2 preW(Register base, int sign, Register index) {
        return new Address2 (true, ADDR_REG, base, index, sign, true, 0, 0);
    }
    ...
    public static Address2 preW(Register base, int sign, Register index, int shift, int imm) {
        return new Address2 (true, ADDR_SCALE, base, index, sign, true, shift, imm);
    }
    ...
    public static Address2 post(Register base, int imm12) {
        return new Address2 (false, ADDR_IMM, base, NO_REG, imm12, false, 0, 0);
    }
    ...
    public static Address2 post(Register base, int sign, Register index) {
        return new Address2 (false, ADDR_REG, base, index, sign, false, 0, 0);
    }
    ...
    public static Address2 post(Register base, int sign, Register index, int shift, int imm) {
        return new Address2 (false, ADDR_SCALE, base, index, sign, false, shift, imm);
    }
