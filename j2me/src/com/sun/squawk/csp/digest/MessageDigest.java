...
public abstract class MessageDigest extends MessageDigestSpi {
    ...
    public static MessageDigest getInstance(String algorithm) throws NoSuchAlgorithmException {
        ...
        if (Klass.DEBUG && Tracer.isTracing("svmload")) {
            Tracer.traceln(" Attempting to load hash: " + algorithm);
        }


        try {
            Class c = Class.forName("com.sun.squawk.csp.digest." + algorithm.toUpperCase());
            ...
            if (o instanceof MessageDigestSpi) {
                MessageDigest delegate = new Delegate((MessageDigestSpi)o, algorithm);
                return delegate;
            }
    ...
    public String toString() {
        String msg = algorithm + " Message Digest, ";
    ...
    static class Delegate extends MessageDigest {
        ...
        public byte[] getAlgorithmID() {
            return digestSpi.getAlgorithmID();
        }
    }
}
