...
public abstract class MessageDigestSpi {
    ...
    /**
     *   Returns the AlgorithmIdentifier associated with the particular hash function as
     *   part of the DigestInfo.
     *
     *    DigestInfo ::= SEQUENCE {
     ...
     *    contains the hash value.  L
     *
     *   Used when decoding the hash function from a signature.
     *
     *  @see ftp://ftp.rfc-editor.org/in-notes/rfc3447.txt
     */
    public abstract byte[] getAlgorithmID();
}
