...
class Symbols {
    ...
    public static class Method {
        ...
        /**
         * Sets the signature of this method. This can only be done once.
         *
        ...
        public void setSignature(String signature) {
            ...
            Assert.that(this.signature == null, "cannot modify 'signature' field");
        ...
        public void setFilePath(String filePath) {
            ...
            Assert.that(this.filePath == null, "cannot modify 'filePath' field");
        ...
        public void setLineNumberTable(String table) {
            ...
            Assert.that(startPCs == null && lineNumbers == null, "cannot modify line number table");
...
//        }
     ...
     */
    public void loadIfFileExists(String fileName) {
        ...
        try {
            ...
            System.err.println("warning: error while loading symbols from " + fileName + ": " + ex);
//            ex.printStackTrace();
        } finally {
            if (fis != null) {
                try {
     ...
     */
    public void relocate(AddressRelocator relocator) {
        ...
        while (keys.hasMoreElements()) {
            ...
            relocatedSymbols.put(relocator.relocate(address), symbol);
        }
     ...
     * @return the symbolic information for the method at <code>address</code>
     */
    public Method lookupMethod(long address) {
        Object entry = symbols.get(address);
        Assert.that(entry != null, "unknown method: " + address);
        return (Method)entry;
    }
    ...
    public String lookupNativeMethod(int identifier) {
        ...
        Assert.that(entry != null, "unknown native method identifier: " + identifier);
        return (String)entry;
    }
