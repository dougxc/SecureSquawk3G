...
//                || (instruction instanceof Phi && ((Phi)instruction).getTarget().isBackwardBranchTarget() == false)
   ...
   private String traceToString(Instruction instruction, String prefix) {
    ...
    public void doArithmeticOp(ArithmeticOp instruction) {
        out.append(Mnemonics.OPCODES[instruction.getOpcode()]);
    }
    ...
    public void doArrayLength(ArrayLength instruction) {
        out.append(Mnemonics.OPCODES[OPC.ARRAYLENGTH]);
    }
...
/*end[FLOATS]*/
        ...
        out.append(Mnemonics.OPCODES[opcode]);
    }
...
/*end[FLOATS]*/
    ...
    out.append(Mnemonics.OPCODES[opcode] + " " + getAddressOf(target));
    }
    ...
    public void doCheckCast(CheckCast instruction) {
        out.append(Mnemonics.OPCODES[OPC.CHECKCAST]+" "+instruction.getType());
    }
    ...
    public void doComparisonOp(ComparisonOp instruction) {
        switch (instruction.getJVMOpcode()) {
            case Opcode.opc_lcmp:   out.append("call java.lang.VM.lcmp");  break;
            case Opcode.opc_fcmpl:  out.append("call java.lang.VM.fcmpl"); break;
            case Opcode.opc_fcmpg:  out.append("call java.lang.VM.fcmpg"); break;
            case Opcode.opc_dcmpl:  out.append("call java.lang.VM.dcmpl"); break;
            case Opcode.opc_dcmpg:  out.append("call java.lang.VM.dcmpg"); break;
            default: {
    ...
    public void doIncDecLocal(IncDecLocal instruction) {
        out.append(Mnemonics.OPCODES[instruction.isIncrement() ? OPC.INC : OPC.DEC] + " " + instruction.getLocal());
    }
    ...
    public void doInstanceOf(InstanceOf instruction) {
        out.append(Mnemonics.OPCODES[OPC.INSTANCEOF]+" "+instruction.getCheckType());
    }
    ...
    public void doFindSlot (FindSlot instruction) {
        ...
        out.append(Mnemonics.OPCODES[OPC.FINDSLOT] + member(method));
    }
...
/*end[FLOATS]*/
        ...
        out.append(Mnemonics.OPCODES[opcode] /*+ " " + method*/);
    }
...
/*end[FLOATS]*/
        ...
        out.append(Mnemonics.OPCODES[opcode] + member(method));
    }
...
/*end[FLOATS]*/
        ...
        out.append(Mnemonics.OPCODES[opcode] + " " + value);
    }
    ...
    public void doCatch(Catch instruction) {
        ...
        if (instruction.isControlFlowTarget()) {
            out.append(Mnemonics.OPCODES[OPC.CONST_NULL]);
            out.append("\n    ");
        }

        IRExceptionHandler handler = ir.getExceptionHandler(instruction);
        ...
        out.append(" " + instruction.getType().getName() + " [" + getAddressOf(handler.getEntry()) + " ... " + getAddressOf(handler.getExit()) + "]");
    }
...
/*end[FLOATS]*/
        ...
        out.append(Mnemonics.OPCODES[opcode] + member(field));
    }
...
/*end[FLOATS]*/
    ...
    public void doLoadLocal(LoadLocal instruction) {
        out.append(Mnemonics.OPCODES[OPC.LOAD] + " " + instruction.getLocal());
    }
    ...
    public void doMonitorEnter(MonitorEnter instruction) {
        out.append(Mnemonics.OPCODES[instruction.getObject() == null ? OPC.CLASS_MONITORENTER : OPC.MONITORENTER]);
    }
    ...
    public void doMonitorExit(MonitorExit instruction) {
        out.append(Mnemonics.OPCODES[instruction.getObject() == null ? OPC.CLASS_MONITOREXIT : OPC.MONITOREXIT]);
    }
    ...
    public void doNewArray(NewArray instruction) {
        out.append(Mnemonics.OPCODES[OPC.NEWARRAY] + " " + instruction.getType().getName());
    }
    ...
    public void doNewDimension(NewDimension instruction) {
        out.append(Mnemonics.OPCODES[OPC.NEWDIMENSION]);
    }
    ...
    public void doNew(New instruction) {
        out.append(Mnemonics.OPCODES[OPC.NEW] + " " + instruction.getRuntimeType().getName());
    }
    ...
    public void doPop(Pop instruction) {
        if (instruction.value().isOnStack()) {
            if (instruction.value().getType().isDoubleWord()) {
                out.append(Mnemonics.OPCODES[OPC.POP_2]);
            } else {
                out.append(Mnemonics.OPCODES[OPC.POP_1]).append(' ').append(instruction.value());
            }
        } else {
            out.append("/* pop */");
        }
...
/*end[FLOATS]*/
    ...
    public void doStoreLocal(StoreLocal instruction) {
        out.append(Mnemonics.OPCODES[OPC.STORE] + " " + instruction.getLocal());
    }
    ...
    public void doThrow(Throw instruction) {
        out.append(Mnemonics.OPCODES[OPC.THROW] + " " + instruction.getThrowable().getType().getName());
    }
}
