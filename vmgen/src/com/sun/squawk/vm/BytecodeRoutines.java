...
/*end[FLOATS]*/
    ...
    abstract protected void do_if(int lth, int cc, Type t);
    ...
    abstract protected void do_this_getfield(Type t);
    abstract protected void do_putfield(Type t);
    abstract protected void do_this_putfield(Type t);
    ...
    abstract protected void do_res(int n);
