...
/**
 * This class defines the switch table used by the Squawk jitter.
 * It was automatically generated as a part of the build process
 * and should not be edited by hand.
 *
 * @author   Nik Shaylor
 */
abstract public class JitterSwitch extends Common implements Types {

    /**
     * The the immediate operand value of the current bytecode.
     */
    protected int iparm;

    /**
     * Generate the native code for a bytecode.
     *
     * @param opcode the opcode to jit
     */
    protected void do_switch(int opcode) {
        ...
        switch(opcode) {
            ...
            case OPC.THIS_GETFIELD_I:             iparmUByte();
            case OPC.THIS_GETFIELD_I_WIDE:        do_this_getfield(INT);             break;
            case OPC.THIS_GETFIELD_B:             iparmUByte();
            case OPC.THIS_GETFIELD_B_WIDE:        do_this_getfield(BYTE);            break;
            case OPC.THIS_GETFIELD_S:             iparmUByte();
            case OPC.THIS_GETFIELD_S_WIDE:        do_this_getfield(SHORT);           break;
            case OPC.THIS_GETFIELD_C:             iparmUByte();
            case OPC.THIS_GETFIELD_C_WIDE:        do_this_getfield(USHORT);          break;
            case OPC.THIS_GETFIELD_O:             iparmUByte();
            case OPC.THIS_GETFIELD_O_WIDE:        do_this_getfield(OOP);             break;
            case OPC.THIS_GETFIELD_L:             iparmUByte();
            case OPC.THIS_GETFIELD_L_WIDE:        do_this_getfield(LONG);            break;
            ...
            case OPC.THIS_PUTFIELD_I:             iparmUByte();
            case OPC.THIS_PUTFIELD_I_WIDE:        do_this_putfield(INT);             break;
            case OPC.THIS_PUTFIELD_B:             iparmUByte();
            case OPC.THIS_PUTFIELD_B_WIDE:        do_this_putfield(BYTE);            break;
            case OPC.THIS_PUTFIELD_S:             iparmUByte();
            case OPC.THIS_PUTFIELD_S_WIDE:        do_this_putfield(SHORT);           break;
            case OPC.THIS_PUTFIELD_O:             iparmUByte();
            case OPC.THIS_PUTFIELD_O_WIDE:        do_this_putfield(OOP);             break;
            case OPC.THIS_PUTFIELD_L:             iparmUByte();
            case OPC.THIS_PUTFIELD_L_WIDE:        do_this_putfield(LONG);            break;
            ...
            case OPC.RES_0:                       iparmNone();
                                                  do_res(0);                         break;
/*if[FLOATS]*/
            case OPC.IF_EQ_F:                     iparmByte();
            case OPC.IF_EQ_F_WIDE:                do_if(1, EQ, FLOAT);               break;
            case OPC.IF_NE_F:                     iparmByte();
            case OPC.IF_NE_F_WIDE:                do_if(1, NE, FLOAT);               break;
            case OPC.IF_LT_F:                     iparmByte();
            case OPC.IF_LT_F_WIDE:                do_if(1, LT, FLOAT);               break;
            case OPC.IF_LE_F:                     iparmByte();
            case OPC.IF_LE_F_WIDE:                do_if(1, LE, FLOAT);               break;
            case OPC.IF_GT_F:                     iparmByte();
            case OPC.IF_GT_F_WIDE:                do_if(1, GT, FLOAT);               break;
            case OPC.IF_GE_F:                     iparmByte();
            case OPC.IF_GE_F_WIDE:                do_if(1, GE, FLOAT);               break;
            case OPC.IF_CMPEQ_F:                  iparmByte();
            case OPC.IF_CMPEQ_F_WIDE:             do_if(2, EQ, FLOAT);               break;
            case OPC.IF_CMPNE_F:                  iparmByte();
            case OPC.IF_CMPNE_F_WIDE:             do_if(2, NE, FLOAT);               break;
            case OPC.IF_CMPLT_F:                  iparmByte();
            case OPC.IF_CMPLT_F_WIDE:             do_if(2, LT, FLOAT);               break;
            case OPC.IF_CMPLE_F:                  iparmByte();
            case OPC.IF_CMPLE_F_WIDE:             do_if(2, LE, FLOAT);               break;
            case OPC.IF_CMPGT_F:                  iparmByte();
            case OPC.IF_CMPGT_F_WIDE:             do_if(2, GT, FLOAT);               break;
            case OPC.IF_CMPGE_F:                  iparmByte();
            case OPC.IF_CMPGE_F_WIDE:             do_if(2, GE, FLOAT);               break;
            case OPC.IF_EQ_D:                     iparmByte();
            case OPC.IF_EQ_D_WIDE:                do_if(1, EQ, DOUBLE);              break;
            case OPC.IF_NE_D:                     iparmByte();
            case OPC.IF_NE_D_WIDE:                do_if(1, NE, DOUBLE);              break;
            case OPC.IF_LT_D:                     iparmByte();
            case OPC.IF_LT_D_WIDE:                do_if(1, LT, DOUBLE);              break;
            case OPC.IF_LE_D:                     iparmByte();
            case OPC.IF_LE_D_WIDE:                do_if(1, LE, DOUBLE);              break;
            case OPC.IF_GT_D:                     iparmByte();
            case OPC.IF_GT_D_WIDE:                do_if(1, GT, DOUBLE);              break;
            case OPC.IF_GE_D:                     iparmByte();
            case OPC.IF_GE_D_WIDE:                do_if(1, GE, DOUBLE);              break;
            case OPC.IF_CMPEQ_D:                  iparmByte();
            case OPC.IF_CMPEQ_D_WIDE:             do_if(2, EQ, DOUBLE);              break;
            case OPC.IF_CMPNE_D:                  iparmByte();
            case OPC.IF_CMPNE_D_WIDE:             do_if(2, NE, DOUBLE);              break;
            case OPC.IF_CMPLT_D:                  iparmByte();
            case OPC.IF_CMPLT_D_WIDE:             do_if(2, LT, DOUBLE);              break;
            case OPC.IF_CMPLE_D:                  iparmByte();
            case OPC.IF_CMPLE_D_WIDE:             do_if(2, LE, DOUBLE);              break;
            case OPC.IF_CMPGT_D:                  iparmByte();
            case OPC.IF_CMPGT_D_WIDE:             do_if(2, GT, DOUBLE);              break;
            case OPC.IF_CMPGE_D:                  iparmByte();
            case OPC.IF_CMPGE_D_WIDE:             do_if(2, GE, DOUBLE);              break;
            ...
            case OPC.THIS_GETFIELD_F:             iparmUByte();
            case OPC.THIS_GETFIELD_F_WIDE:        do_this_getfield(FLOAT);           break;
            case OPC.THIS_GETFIELD_D:             iparmUByte();
            case OPC.THIS_GETFIELD_D_WIDE:        do_this_getfield(DOUBLE);          break;
            ...
            case OPC.THIS_PUTFIELD_F:             iparmUByte();
            case OPC.THIS_PUTFIELD_F_WIDE:        do_this_putfield(FLOAT);           break;
            case OPC.THIS_PUTFIELD_D:             iparmUByte();
            case OPC.THIS_PUTFIELD_D_WIDE:        do_this_putfield(DOUBLE);          break;
